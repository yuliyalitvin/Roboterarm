...
%     view(2) % Perspektive --> frontview
    ...
    vert = [0 0 0; kiste1_groesse 0 0; kiste1_groesse kiste1_groesse 0; 0 kiste1_groesse 0; 0 0 kiste1_groesse; kiste1_groesse 0 kiste1_groesse; kiste1_groesse kiste1_groesse kiste1_groesse; 0 kiste1_groesse kiste1_groesse];
    fac = [1 2 6 5;2 3 7 6;3 4 8 7;4 1 5 8;1 2 3 4;5 6 7 8];
    kiste_1 = hgtransform;
    patch('Vertices',vert,'Faces',fac, 'FaceVertexCData',hsv(6),'FaceColor','red', 'Parent', kiste_1);
    kiste_1.Matrix = makehgtform('translate',[k1_x, k1_y, k1_z]);
    %kiste_1.id = 1; 
    hold on 
    ...
    vert = [0 0 0; kiste2_groesse 0 0; kiste2_groesse kiste2_groesse 0; 0 kiste2_groesse 0; 0 0 kiste2_groesse; kiste2_groesse 0 kiste2_groesse; kiste2_groesse kiste2_groesse kiste2_groesse; 0 kiste2_groesse kiste2_groesse];
    fac = [1 2 6 5;2 3 7 6;3 4 8 7;4 1 5 8;1 2 3 4;5 6 7 8];
    kiste_2 = hgtransform;
    patch('Vertices',vert,'Faces',fac, 'FaceVertexCData',hsv(6),'FaceColor','yellow', 'Parent', kiste_2);
    kiste_2.Matrix = makehgtform('translate',[k2_x, k2_y, k2_z]);
    %kiste_2.id = 2; 
    hold on 
    ...
    vert = [0 0 0; kiste3_groesse 0 0; kiste3_groesse kiste3_groesse 0; 0 kiste3_groesse 0; 0 0 kiste3_groesse; kiste3_groesse 0 kiste3_groesse; kiste3_groesse kiste3_groesse kiste3_groesse; 0 kiste3_groesse kiste3_groesse];
    fac = [1 2 6 5;2 3 7 6;3 4 8 7;4 1 5 8;1 2 3 4;5 6 7 8];
    kiste_3 = hgtransform;
    patch('Vertices',vert,'Faces',fac, 'FaceVertexCData',hsv(6),'FaceColor','green', 'Parent', kiste_3);
    kiste_3.Matrix = makehgtform('translate',[k3_x, k3_y, k3_z]);
    %kiste_3.id = 3; 
...
% Schnelligkeit des Pfadabfahrens vom Roboterarm einstellen
    ...
    for i = 1:zaehler
        ...
        if(i == 3)
             kiste_1.Matrix = makehgtform('translate',[(am1_x + (am1_b/3)) am1_y 0]);
            %set(kiste_1, 'Position', [(am1_x + (am1_b/3)) am1_y k1_b k1_h])
        elseif(i == 6)
            kiste_2.Matrix = makehgtform('translate',[(am2_x + (am2_b/3)) am2_y 0]);
            %set(kiste_2, 'Position', [(am2_x + (am2_b/3)) am2_y k2_b k2_h])
        elseif(i == 9)
            kiste_3.Matrix = makehgtform('translate',[(am3_x + (am3_b/3)) am2_y 0]);
...
%           filename = '3D_Roboterarm_frontview.gif';
%           frame = getframe(gcf);
...
%           filename = '3D_Roboterarm_sideview.gif';
%           frame = getframe(gcf);
%           [SIf,cm] = rgb2ind(frame.cdata,256);
%           if i == 1
%             imwrite(SIf,cm,filename,'Loop',Inf,'Delay',1);
